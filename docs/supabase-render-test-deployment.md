...
Apply migrations `001` through `024` before starting the application. Migration
...
- Submit a Chairman recovery request and confirm only the Secretary can see it
  and issue the temporary recovery password from **Chairman Recovery**.
