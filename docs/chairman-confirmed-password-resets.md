...
1. A Member selects **Request password reset** on the sign-in screen and enters
   their registered phone number or email address.
...
3. Every active Chairman receives an unread in-app notification that links to
   **Account Access**. No email or SMS is sent.
